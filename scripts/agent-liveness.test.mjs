...
ok('resolveLastActivityMs: parses SQLite "YYYY-MM-DD HH:MM:SS" (space sep) startedAt',
  resolveLastActivityMs({ startedAt: '2026-06-04 12:00:00' }) === Date.parse('2026-06-04T12:00:00'));
